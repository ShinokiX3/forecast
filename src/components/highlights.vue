...
import { pressure, time } from '../utils'
...
const sunrise = computed(() => time(props.weather.sys.sunrise + timezone.value))
const sunset = computed(() => time(props.weather.sys.sunset + timezone.value))
</script>
    ...
    <div class="highlights-wrapper">
      <div class="highlight">
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-justify">
              <div class="info-main">
                <div class="info-main-num">{{ weather.wind.speed }}</div>
                <div class="info-main-text">m/s</div>
              </div>
              <div class="info-main">
                <div class="info-main-num">{{ weather.wind.deg }}</div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div v-if="weather.wind.gust" class="card-small-data">
              <div class="info-main-num">{{ weather.wind.gust }}</div>
              <div class="info-main-text">m/s</div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-centered">
              <div class="info-main">
                <div class="info-main-num">{{ pressure(weather.main.pressure) }}</div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{ weather.main.feels_like }}</div>
      ...
      <div class="highlight">
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{ weather.clouds.all }}</div>
